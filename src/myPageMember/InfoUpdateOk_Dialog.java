...
public class InfoUpdateOk_Dialog extends JDialog implements ActionListener {
	...
	public InfoUpdateOk_Dialog(String title, boolean modal, String match) {
	...
	private void initText() {
		if(match.equals("o")) {
			textlbl = new JLabel("수정이 완료되었습니다.", JLabel.CENTER);
			
		} else if(match.equals("x")) {
			textlbl = new JLabel("수정이 실패하였습니다.", JLabel.CENTER);
